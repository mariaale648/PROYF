...
namespace PROYF {
	...
	/// <summary>
	/// Resumen de Asignar_guardia
	/// </summary>
	public ref class Asignar_guardia : public System::Windows::Forms::Form
	{
	public:
		Asignar_guardia(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Seleccionar guardia(s):";
			// 
			// label2
			// 
